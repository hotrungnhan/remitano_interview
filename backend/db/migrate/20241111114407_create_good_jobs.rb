...
class CreateGoodJobs < ActiveRecord::Migration[7.2]
  def change
    ...
    create_table :good_jobs, id: :ulid do |t|
      t.text :queue_name
      t.integer :priority
    ...
    create_table :good_job_batches, id: :ulid do |t|
      t.timestamps
      t.text :description
    ...
    create_table :good_job_executions, id: :ulid do |t|
      t.timestamps
    ...
    create_table :good_job_processes, id: :ulid do |t|
      t.timestamps
      t.jsonb :state
      t.integer :lock_type, limit: 2
    end

    create_table :good_job_settings, id: :ulid do |t|
      t.timestamps
      t.text :key
      t.jsonb :value
